...
file_1 = open('opt_pyFE/opt_pyFE_estandarizado.py').read()
exec(file_1)

file_2 = open('opt_pyFE/defmodelmach.py').read()
exec(file_2)

file_3 = open('opt_pyFE/Empaquetado_bandas_bollinger_analiticos.py').read()
exec(file_3)
...
best_weights, retorno, volatilidad, sharpe_ratio = encontrar_mejor_portafolio(weight, 
                                                                              ReturnEsp, 
                                                                              VolEsp, 
                                                                              RadioSharpe)
...
rendimiento, rendimiento_medio, covmatrix = getdata(tickers, 
                                                    start_date, 
                                                    end_date)
...
portfolio_sims, portResults = MonteCarlo(mc_sims, 
                                         T, 
                                         rendimiento_medio, 
